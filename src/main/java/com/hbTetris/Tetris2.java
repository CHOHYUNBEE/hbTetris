...
public class Tetris2 extends JPanel implements Runnable, ActionListener
{
...
//        holdrepaint=true;
   ...
   public class KeyHandler extends KeyAdapter
    {
    	private Tetris2 tetris2;
    	
    	public KeyHandler(Tetris2 tetris2) {
    	...
    	public void keyPressed(KeyEvent e)
        {
            ...
            {
                case  KeyEvent.VK_A:                        // <-
                	tetris2.movecurpiece(-1, 0, false);         //x 醫뚰몴瑜� �쇊履쎌쑝濡� -1 留뚰겮 ��吏곸엫.
                	tetris2.neednewpiece = false;            //�깉 �뵾�뒪�뒗 �븘�슂�뾽怨�,
                	tetris2.needpieceP = false;
                	tetris2.repaint();                     //update �슂泥�
                    break;
                    
                case KeyEvent.VK_D:                        //->
                	tetris2.movecurpiece(1, 0, false);         //x 醫뚰몴瑜� �삤瑜몄そ�쑝濡� +1 �씠�룞
                	tetris2.neednewpiece = false;
                	tetris2.needpieceP = false;
                	tetris2.repaint();
                    break;

                case KeyEvent.VK_W:                        //rotate
                    if(!tetris2.neednewpiece && tetris2.curpiecenum != 4)
                    {                           //�쁽醫뚰몴瑜� �쑀吏��븳 �긽�깭�뿉�꽌 rotate
                    	tetris2.movecurpiece(0,0,true);
                    	tetris2.repaint();
                    	tetris2.needpieceP = false;
                    	tetris2.neednewpiece = false;
                    }
                    break;
                case KeyEvent.VK_ENTER:   //한번에 내리기
                    while(tetris2.movecurpiece(0,-1,false));
                    tetris2.repaint();
                    break;
                case KeyEvent.VK_S:      // �넃
                	tetris2.movecurpiece(0,-1,false);
                	tetris2.neednewpiece = false;
                	tetris2.needpieceP = false;
                	tetris2.repaint();
                    break;
                case KeyEvent.VK_SHIFT://h
                    if(tetris2.change)
                    {
                    	tetris2.hold();
                    	tetris2.neednewpiece = false;
                    	tetris2.needpieceP = false;
                    	tetris2.holdrepaint =false;
                    	tetris2.repaint();
                    }
                    break;
